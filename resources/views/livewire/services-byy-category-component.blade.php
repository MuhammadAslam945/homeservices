                        ...
                        <div class="portfolioContainer">
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 nature hsgrids"
                                ...
                                <a class="g-list" href="{{route('home.service_details',['service_slug'=>$service->slug])}}">
                                    <div class="img-hover">
                                        <img src="{{asset('images/services/thumbnails')}}/{{$service->thumnail}}" alt="{{$service->name}}"
                            ...
                            @endforeach
                            @else
                            <div class="col-md-12"><p class="text-center text-info">There is no Service availlablle right now.</p></div>
                            @endif
